    ...
    for fobj in full_file_paths:
        ...
        if 'analyzed' in fobj: # skip any already analyzed files
            ...
            if measurement_name == measurement_types[0]: # res2t
                get_DrainCurrent_res2t(data) # convert data sheet
            ...
            if measurement_name == measurement_types[2]: # vds-id#1@1
                vbg_start = get_GateVoltageStart_vds_id(settings) # get vbg start
                vbg_final = get_GateVoltageFinal_vds_id(settings) # get vbg final
                vbg_step = get_GateVoltageStep_vds_id(settings) # get vbg stepOA
